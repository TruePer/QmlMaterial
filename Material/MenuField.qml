...
Item {
    ...
    property color textColor:   Theme.light.hintColor
    ...
    property bool showMenuInCenter: true
    ...
    Rectangle {
        ...
        color: field.hasError ? field.errorColor : field.activeFocus ? field.accentColor : textColor
    ...
    Label {
        ...
        font.pixelSize: Units.dp(12)
        color: field.hasError ? field.errorColor : Qt.darker(textColor)
